...
export const PISTE_COLORS: Record<Difficulty, { color: string; colorHighlight: string; icon: string; label: string }> = {
...
export const LIFT_COLORS: Record<LiftType, { color: string; colorHighlight: string; icon: string }> = {
