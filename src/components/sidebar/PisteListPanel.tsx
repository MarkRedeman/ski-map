/**
 * PisteListPanel - Sidebar panel for browsing and selecting pistes/lifts/peaks/villages/restaurants
 *
 * Features:
 * - Tabs to switch between Pistes, Lifts, Peaks, Villages, and Restaurants
...
type Tab = 'pistes' | 'lifts' | 'peaks' | 'villages' | 'restaurants';
...
const CAMERA_DISTANCES = {
  ...
  restaurant: 500, // Close enough to see the restaurant location
};
...
export function PisteListPanel() {
  ...
  const getPlaceholder = () => {
    switch (activeTab) {
      case 'pistes':
        return 'Search pistes...';
      case 'lifts':
        return 'Search lifts...';
      case 'peaks':
        return 'Search peaks...';
      case 'villages':
        return 'Search villages...';
      case 'restaurants':
...
function RestaurantList({ searchQuery }: RestaurantListProps) {
  ...
  // Generate Link search params for a restaurant
  const getSelectSearch = useCallback(
