...
// Sölden ski area center point (Giggijoch)
export const SOLDEN_CENTER = {
  lat: 46.9147,
  lon: 10.9975,
  elevation: 2284, // meters
}
 ...
 */
export function coordsToLocal(coordinates: [number, number][], elevation = 0): [number, number, number][] {
 ...
 */
export function localToGeo(x: number, y: number, z: number): { lat: number; lon: number; elevation: number } {
